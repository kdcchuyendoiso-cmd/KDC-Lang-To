...
# --- CSS TÙY CHỈNH GIAO DIỆN (THU NHỎ SIDEBAR VÀ CỠ CHỮ BẢNG) ---
st.markdown("""
<style>
    /* Điều chỉnh độ rộng của thanh bên (Sidebar) vừa vặn hơn */
    ...
    /* Thu nhỏ chữ và tối ưu hóa hiển thị bảng dữ liệu (dataframe và data_editor) */
